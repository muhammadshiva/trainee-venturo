...
import 'package:coffee_app/modules/features/home/view/components/menu_list.dart';
import 'package:coffee_app/modules/features/home/view/components/search_bar.dart';
import 'package:coffee_app/shared/styles/shapes.dart';
import 'package:coffee_app/shared/widgets/custom_error_vertical.dart';
        ...
        child: ListView(
          children: [
            ...
            Obx(
              () => Conditional.single(
                context: context,
                conditionBuilder: (context) => HomeController.to.categoryMenu.value != 'drink',
            ...
            Obx(
              () => Conditional.single(
                context: context,
                conditionBuilder: (context) => HomeController.to.categoryMenu.value != 'food',
                widgetBuilder: (context) => Column(
                  mainAxisSize: MainAxisSize.min,
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) => Obx(
          () => FilterMenu(
            isSelected: HomeController.to.categoryMenu.value == filters[index]['value'],
            onTap: () => HomeController.to.setCategoryMenu(filters[index]['value']!),

...
import 'package:coffee_app/modules/features/menu/view/components/variant_chip.dart';
              ...
              children: DetailMenuController.to.toppings
                  .map<Widget>(
                    (topping) => VariantChip(
                      ...
                      onTap: () => DetailMenuController.to.toggleTopping(topping),
                      isSelected: DetailMenuController.to.selectedToppings.contains(topping),
                    ),
                  )
                  .toList(),
            ),

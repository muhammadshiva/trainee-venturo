...
import 'package:coffee_app/modules/features/profile/repositories/user_repository.dart';
import 'package:coffee_app/modules/features/profile/view/components/email_bottom_sheet.dart';
import 'package:coffee_app/modules/features/profile/view/components/language_bottom_sheet.dart';
import 'package:coffee_app/modules/features/profile/view/components/logout_dialog.dart';
import 'package:coffee_app/modules/features/profile/view/components/name_bottom_sheet.dart';
import 'package:coffee_app/modules/features/profile/view/components/phone_bottom_sheet.dart';
import 'package:coffee_app/modules/models/user.dart';
import 'package:coffee_app/shared/styles/shapes.dart';
import 'package:coffee_app/shared/widgets/image_picker_dialog.dart';
...
class ProfileController extends GetxController {
  ...
  Future<void> loadData() async {
    ...
    UserResponse userRes = await UserRepository.get();
  ...
  Future<void> openUpdatePhotoDialog() async {
    ...
    UserResponse userRes = await UserRepository.updatePhoto(base64Image);
  ...
  Future<void> openVerifyIDDialog() async {
    ...
    /// Simpan gambar melalui API
    UserResponse userRes = await UserRepository.updateKTP(base64Image);
  ...
  /// Update user data
  Future<void> updateUser({String? nama, DateTime? tglLahir, String? telepon, String? email, String? pin}) async {
    ...
    UserResponse userRes = await UserRepository.update(data);

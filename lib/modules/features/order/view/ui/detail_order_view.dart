...
import 'package:coffee_app/modules/features/order/view/components/checked_step.dart';
import 'package:coffee_app/modules/features/order/view/components/detail_order_card.dart';
import 'package:coffee_app/modules/features/order/view/components/unchecked_step.dart';
import 'package:coffee_app/shared/styles/shapes.dart';
import 'package:coffee_app/shared/widgets/empty_data_list_view.dart';
import 'package:coffee_app/shared/widgets/rect_shimmer.dart';
import 'package:coffee_app/shared/widgets/server_error_list_view.dart';
            ...
            () => Conditional.single(
              ...
              widgetBuilder: (context) => Padding(
                ...
                child: TextButton(
                  ...
                  child: Text(
                    'Cancel'.tr,
                    style: Get.textTheme.labelMedium?.copyWith(color: AppColor.redColor),
                  ),
                ),
              ),
            ...
            child: Column(
              ...
              children: [
                ...
                TileOption(
                  ...
                  message: DetailOrderController.to.order.value!.total.toRupiah(),
                  titleStyle: Get.textTheme.headlineSmall,
                  messageStyle: Get.textTheme.labelLarge!.copyWith(color: AppColor.blueColor),
                ),
                ...
                ...Conditional.list(
                  ...
                  conditionBuilder: (context) =>
                      DetailOrderController.to.order.value!.diskon == 1 && DetailOrderController.to.order.value!.potongan > 0,
                  widgetBuilder: (context) => [
                    TileOption(
                      icon: AssetConst.iconDiscount,
                      iconSize: 24.r,
                      title: 'Discount'.tr,
                      message: DetailOrderController.to.order.value!.potongan.toRupiah(),
                      titleStyle: Get.textTheme.headlineSmall,
                      messageStyle: Get.textTheme.bodySmall!.copyWith(color: AppColor.redColor),
                    ),
                    Divider(
                ...
                ...Conditional.list(
                  context: context,
                  conditionBuilder: (context) => DetailOrderController.to.order.value!.id_voucher != 0,
                  widgetBuilder: (context) => [
                    TileOption(
                      ...
                      title: 'voucher'.tr,
                      message: DetailOrderController.to.order.value!.potongan.toRupiah(),
                      messageSubtitle: DetailOrderController.to.order.value!.nama_voucher,
                      titleStyle: Get.textTheme.headlineSmall,
                      messageStyle: Get.textTheme.bodySmall!.copyWith(color: AppColor.redColor),
                    ),
                    Divider(
                ...
                TileOption(
                  ...
                  message: DetailOrderController.to.order.value!.total_bayar.toRupiah(),
                  titleStyle: Get.textTheme.headlineSmall,
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Conditional.single(
                        context: context,
                        conditionBuilder: (context) =>
                            DetailOrderController.to.order.value!.status == 0 || DetailOrderController.to.order.value!.status == 1,
                    ...
                    Expanded(
                      ...
                      child: Conditional.single(
                        context: context,
                        conditionBuilder: (context) => DetailOrderController.to.order.value!.status == 2,
                        widgetBuilder: (context) => const CheckedStep(),
                        fallbackBuilder: (context) => const UncheckedStep(),
                      ),
                    ),
                    ...
                    Expanded(
                      ...
                      child: Conditional.single(
                        context: context,
                        conditionBuilder: (context) => DetailOrderController.to.order.value!.status == 3,
                        widgetBuilder: (context) => const CheckedStep(),
                        fallbackBuilder: (context) => const UncheckedStep(),
                      ),
                    ),

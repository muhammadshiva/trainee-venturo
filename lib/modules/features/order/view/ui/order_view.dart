...
import 'package:coffee_app/modules/features/order/view/components/date_picker.dart';
import 'package:coffee_app/modules/features/order/view/components/dropdown_status.dart';
import 'package:coffee_app/modules/features/order/view/components/order_card.dart';
import 'package:coffee_app/modules/features/order/view/components/order_data_empty.dart';
import 'package:coffee_app/shared/styles/shapes.dart';
import 'package:coffee_app/shared/widgets/empty_data_vertical.dart';
        ...
        () => ConditionalSwitch.single(
          ...
          caseBuilders: {
            ...
            'empty': (context) => OrderDataEmpty(
                  ...
                  subtitle: 'The food you ordered will appear here so you can find your favorite menu again!'.tr,
                ),
            'loading': (context) => ListView.separated(
                  padding: EdgeInsets.symmetric(
                    horizontal: 25.r,
          ...
          fallbackBuilder: (context) => ListView(
            ...
            children: [
                ...
                children: [
                  Expanded(
                    child: DropdownStatus(
                      ...
                      onChanged: (value) => OrderController.to.setFilter(category: value),
                    ),
                  ),
                  ...
                  Expanded(
                    child: DatePicker(
                      ...
                      onChanged: (value) => OrderController.to.setFilter(dateRange: value),
                    ),
                  ),
                ],
              ),
              ...
              ...Conditional.list(
                context: context,
                conditionBuilder: (context) => OrderController.to.historyOrderFiltered.isEmpty,
                widgetBuilder: (context) => [
                  100.verticalSpacingRadius,
                  const EmptyDataVertical(),
                  100.verticalSpacingRadius,
                ],
                fallbackBuilder: (context) => OrderController.to.historyOrderFiltered
                    .map(
                      (order) => Padding(
                        padding: EdgeInsets.only(bottom: 16.r),
                        child: OrderCard(
                          order: order,
                          onOrderAgain: () => OrderController.to.onOrderAgain(order),
                          onTap: () => Get.toNamed(
                            AppRoutes.detailOrderView,
                            arguments: order,
                          ),

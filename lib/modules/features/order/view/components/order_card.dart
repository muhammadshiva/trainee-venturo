...
import 'package:coffee_app/shared/widgets/outlined_primary_button.dart';
...
class OrderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    String inputDate = order.tanggal.toString();
                ...
                child: AspectRatio(
                  ...
                  child: Container(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: order.menu.isNotEmpty ? order.menu.first.foto ?? AppConst.defaultMenuPhoto : AppConst.defaultMenuPhoto,
                      fit: BoxFit.contain,
                      height: 75.r,
                      width: 75.r,
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: ConditionalSwitch.single<int>(
                          ...
                          caseBuilders: {
                            0: (context) => Text(
                                  'In queue'.tr,
                                  style: Get.textTheme.labelMedium!.copyWith(color: AppColor.yellowColor),
                                ),
                            1: (context) => Text(
                                  'Preparing'.tr,
                                  style: Get.textTheme.labelMedium!.copyWith(color: AppColor.yellowColor),
                            ...
                            3: (context) => Text(
                                  'Completed'.tr,
                                  style: Get.textTheme.labelMedium!.copyWith(color: AppColor.greenColor),
                                ),
                            4: (context) => Text(
                                  'Canceled'.tr,
                      ...
                      Text(
                        formattedDate,
                        style: Get.textTheme.labelMedium!.copyWith(color: AppColor.greyColor),
                      ),
                    ],
                  ),
                  5.verticalSpacingRadius,
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        ...
                        style: Get.textTheme.labelLarge!.copyWith(color: AppColor.greyColor),
                      ),
                    ],
                  ),

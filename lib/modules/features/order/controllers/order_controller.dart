...
class OrderController extends GetxController {
  ...
  Future<void> fetchOnGoing() async {
    ...
    ListOrderResponse listOrderRes = await OrderRepository.getOnGoing();
  ...
  List<Order> get historyOrderFiltered {
    ...
    /// Filter date
    list.removeWhere((e) => e.tanggal.isBefore(selectedDateRange.start) || e.tanggal.isAfter(selectedDateRange.end));
  ...
  Future<void> fetchHistory() async {
    ...
    ListOrderResponse listOrderRes = await OrderRepository.getHistory();
  ...
  void onOrderAgain(Order order) {
    for (var detail in order.menu) {
      ...
      var menu = HomeController.to.listMenu.firstWhereOrNull((e) => e.idMenu == detail.id_menu);

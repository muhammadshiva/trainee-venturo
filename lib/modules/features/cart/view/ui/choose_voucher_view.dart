...
import 'package:coffee_app/modules/features/cart/view/components/voucher_card.dart';
          ...
          () => ConditionalSwitch.single<String>(
            ...
            caseBuilders: {
              ...
              'loading': (context) => ListView.separated(
                    ...
                    itemBuilder: (context, _) => RectShimmer(height: 216.r, radius: 15.r),
            ...
            fallbackBuilder: (context) => ListView.separated(
              ...
              itemBuilder: (context, index) => VoucherCard(
                ...
                isSelected: CartController.to.vouchers.elementAt(index) == CartController.to.selectedVoucher.value,
                onTap: () => Get.toNamed(
                ...
                onChanged: (value) {
                  if (value == true) {
                    CartController.to.setVoucher(CartController.to.vouchers.elementAt(index));
                  } else {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                10.horizontalSpaceRadius,
                Icon(Icons.check_circle_outline, color: AppColor.blueColor, size: 24.r),
                10.horizontalSpaceRadius,
                Expanded(
                  child: RichText(
                    ...
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: 'The use of vouchers cannot be combined with a discount'.tr,
                          style: Get.textTheme.bodySmall,
                        ),
                        TextSpan(
                          text: ' ${'employee reward program'.tr}',
                          style: Get.textTheme.labelLarge!.copyWith(color: AppColor.blueColor),
                        ),
                      ],
                    ),
                  ),

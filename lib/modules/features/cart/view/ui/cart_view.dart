...
import 'package:coffee_app/shared/widgets/menu_card.dart';
                    ...
                    children: CartController.to.foodItems
                        .map<Widget>(
                          (cartItem) => MenuCard(
                            ...
                            note: cartItem.note,
                            onIncrement: () => CartController.to.increment(cartItem),
                            onDecrement: () => CartController.to.decrement(cartItem),
                            onNoteChanged: (value) => CartController.to.updateNote(cartItem, value),
                            onTap: () {
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Conditional.single(
                      context: context,
                      conditionBuilder: (context) => CartController.to.discountPrice == 0,
                      widgetBuilder: (context) => TileOption(
                        icon: AssetConst.iconDiscount,
                        iconSize: 24.r,
                        title: 'Discount'.tr,
                        message: CartController.to.selectedVoucher.value == null ? 'No discount'.tr : 'Discount can not be combined'.tr,
                        titleStyle: Get.textTheme.headlineSmall,
                    ...
                    Conditional.single(
                      context: context,
                      conditionBuilder: (context) => CartController.to.selectedVoucher.value == null,
                      widgetBuilder: (context) => TileOption(
                      ...
                      fallbackBuilder: (context) => TileOption(
                        ...
                        messageSubtitle: CartController.to.selectedVoucher.value!.nama,
                        titleStyle: Get.textTheme.headlineSmall,
                        messageStyle: Get.textTheme.bodySmall!.copyWith(color: AppColor.redColor),
                        onTap: CartController.to.openVoucherDialog,
                      ),

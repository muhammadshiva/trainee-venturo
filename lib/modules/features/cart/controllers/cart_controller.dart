...
import 'package:coffee_app/modules/features/cart/repositories/discount_repository.dart';
import 'package:coffee_app/modules/features/cart/repositories/order_repository.dart';
import 'package:coffee_app/modules/features/cart/repositories/voucher_repository.dart';
import 'package:coffee_app/modules/features/cart/view/components/delete_cart_item_dialog.dart';
import 'package:coffee_app/modules/features/cart/view/components/discount_info.dart';
import 'package:coffee_app/modules/features/cart/view/components/fingerprint_dialog.dart';
import 'package:coffee_app/modules/features/cart/view/components/order_success_dialog.dart';
import 'package:coffee_app/modules/features/cart/view/components/pin_dialog.dart';
...
class CartController extends GetxController {
  ...
  int get totalDiscount => discounts.fold(0, (total, discount) => total + discount.nominal);
  ...
  Future<void> order() async {
    ...
    if (response != null && response.statusCode == 200 && response.data['status_code'] == 200) {
